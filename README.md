...
## 1. 作业内容
本课程作业是横跨一学期的项目，要求跟随课程进度在项目中实现各种图形学算法，最终完成一个完整的图形学系统，进度自由安排，**`3月31日前`**、**`4月30日前`**、**`5月31日前`**提交**进度报告**即可，**`6月底`**提交**系统报告**、**完整的系统**、**系统使用说明书**和**系统演示视频**，最后一次的具体时间时间视教学情况以及学校考试安排情况而定。
...
- 提交方式：
    ...
    >
    > 3月进度报告提交地址：https://box.nju.edu.cn/u/d/c432d5f4de054daa8a39/
    > 密码：cg2023    
    > 
    > 最终版提交日期为3月31日晚24:00，请勿错过提交期限
    >
    > 查看已提交的文件：https://box.nju.edu.cn/d/0b31b75b38794bccb0af/
    >
