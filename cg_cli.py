    ...
    with open(input_file, 'r') as fp:
        ...
        while line:
            ...
            if line[0] == 'resetCanvas':
                ...
                i=0
                while i<len(p_list):
                    new_list.append((int(p_list[i]),int(p_list[i+1])))
                    i+=2
                algorithm=line[-1]
                item_dict[item_id]=['polygon',new_list,algorithm,np.array(pen_color)]
            elif line[0]=="clip":
                item_id = line[1]
                x0 = int(line[2])
                y0 = int(line[3])
                ...
                while i<len(p_list):
                    ...
                    i+=2
                algorithm=line[-1]
                item_dict[item_id]=['curve',new_list,algorithm,np.array(pen_color)]
            line = fp.readline()
